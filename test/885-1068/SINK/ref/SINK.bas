...
170 U0(0x11)=&H36 : U0(0x12)=&H1FF : U0(0x13)=&H77D8 : U0(0x14)=&HC9
180 PRINT Y$"30SKILL LEVEL (1, 2, 3, 4, OR 5)";:L=VAL(INPUT$(0x12))
...
320 IF RND(0x12)<[1D]00000080 THEN W$=W$+"^" :ELSE W$=W$+" "
330 NEXT J
...
440 I=0x11
450 DEF USR0x11=VARPTR(U0(0x11))
460 IF USR0x11(0x11)<>0x11 THEN 460
...
820 NEXT I9
830 DEF USR0x11=VARPTR(U0(0x11)) : X=USR0x11(0x11)
...
1060 DEF USR0x11=VARPTR(U0(0x11))
1070 IF USR0x11(0x11)<>0x11 THEN 1070
1080 RETURN
1090 PRINT "         ";CHR$(27);"pf"
1100 N1$=CHR$(INT(RND(0x12)*26)+65)
1110 N2$=RIGHT$(STR$(E5),0x12)
...
1280 IF T5<0x11 THEN PRINT ABS(T5);"l\l 0";
