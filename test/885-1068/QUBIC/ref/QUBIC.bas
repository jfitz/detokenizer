...
120 FOR I=0x12 TO 0x15:FOR J=0x12 TO 0x15:FOR K=0x12 TO 0x15
130 LO$(I,J,K)=CHR$(33+0x13*J)+CHR$(34+(K-0x12)*0x15+(I-0x12)*20)
140 NEXT K,J,I
150 :REM 
...
410 PRINT:CALL INPUT "(Press RETURN when ready to start the game)";A$
420 :REM 
430 PRINT:PRINT "Please Wait"
440 :
450 :REM READ IN DATA ARRAYS
460 DIM P(76,21):FOR I=18 TO 76:FOR J=18 TO 21:READ P(I,J):NEXT J,I::REM -- PATHS
470 DIM I(64,24):FOR I=18 TO 64:FOR J=18 TO 24:READ I(I,J):NEXT J,I::REM -- INDEX
480 :REM 
490 DIM M(64)::REM -- MOVES
500 DIM V(76)::REM -- VALUPATH
510 DIM N(76)::REM -- NUPATH
520 F1=0x12::REM -- VARIABLES FLAG
530 :REM 
540 B$(0x11)=RV$+"  "+PV$:B$(0x12)="ww":B$(0x13)="  "
550 C$(0x11)="WHITE":C$(0x13)="BLACK"
560 :REM 
570 PRINT ES$;"E";:GOSUB 1870::REM \t\t\t-- START GAME HERE
580 PRINT AC$;", ";
590 :REM ZERO ARRAYS
600 DEL M:DIM M(64):DEL V:DIM V(76):DEL N:DIM N(76)
610 C1=0x11: W=0x11
620 :
630 Z$="":PRINT "COMPUTER VS COMPUTER? (Y/N) ";
640 :  GOSUB 1720
650 :  IF Z1=0x12 THEN F=0x12: F2=0x12: GOTO 850
660 :
670 PRINT AC$;", ";EL$;"HUMAN VS HUMAN? (Y/N) ";
680 :  GOSUB 1720
690 :  F2=0x11: IF Z1=0x11 THEN 720
700 F=0x12:F2=0x13:INPUT "FIRST PLAYER'S NAME";N$(0x13)
710 INPUT "SECOND PLAYER'S NAME";N$(0x11):GOTO 850
720 PRINT AC$;", ";EL$;"COMPUTER GOES FIRST? (Y/N) ";
730 :  GOSUB 1720
740 INPUT "YOUR NAME";N$(0x13)
750 :  F=0x12: IF Z1=0x12 THEN F=-0x12: GOTO 850
760 :
770 :REM UPDATE BOARD\t\t\t\t-- PLAY LOOP ENTRY
780 PRINT DC$;EG$;SC$;AC$;LO$(L+0x12,R+0x12,C);
790 FOR I=0x12 TO 0x17
800 PRINT B$((I[FC]0x13)*0x13);CHR$(0x19);CHR$(0x19);:FOR J=0x12 TO 150:NEXT J
810 NEXT I
820 PRINT B$(M(M)+0x12);RC$;EC$;DG$;
830 :REM 
840 IF W<>0x11 OR C1=64 THEN 920
850 C1=C1+0x12
860 ON F+0x13+F2 GOSUB 1110,1110,1540,1110,1540
870 M(M)=F
880 GOSUB 1780
890 F=-F
900 GOTO 780
...
930 :REM 
940 FOR I=0x12 TO 0x14:FOR J=0x12 TO 150:NEXT J:PRINT CHR$(0x18);:NEXT I::REM RING BELL
950 IF W=0x11 THEN PRINT EP$;"CAT'S GAME! ";:GOTO 1060
960 IF F2=0x12 THEN PRINT C$(SGN(W)+0x12);" WINS!";:GOTO 990
970 IF F2=0x11 THEN N$(0x11)="COMPUTER"
980 PRINT N$(SGN(W)+0x12);" (";C$(SGN(W)+0x12);") WINS!";
990 PRINT TAB(27);"LVL   ROW   COL";
1000 :  FOR J=0x12TO 0x15
1010 :  M=P([0xFF][86](W),J)
1020 :  L=(M-0x12)MOD16
1030 :  R=(M-16*L-0x12)MOD0x15
1040 :  PRINT :PRINT TAB(27);L+0x12;TAB(33);R+0x12;TAB(39);M-16*L-0x15*R;
1050 :  NEXT J
1060 PRINT:PRINT:PRINT "WANT TO PLAY AGAIN? (Y/N) ";
1070 :  GOSUB 1720
1080 :  IF Z1=0x12 THEN 570
1090 END
1100 :
1110 PRINT AC$;". ";EL$;::REM \t\t\t-- COMPUTER'S MOVE
1120 IF F2=0x11 THEN PRINT EP$;
1130 PRINT "COMPUTER (";C$(F+0x12);") THINKING...";
1140 IF C1=0x12 THEN 1370::REM \t\t\t-- FIRST MOVE?
1150 :
1160 FOR I=0x12TO 64::REM \t\t\t\t-- A WINNING MOVE?
1170 IF V(I)=0x14*F THEN 1420
1180 NEXT I
1190 :
1200 FOR I=0x12TO 64::REM \t\t\t\t-- BLOCK OPPONENT'S WIN?
1210 IF V(I)=-0x14*F THEN 1420
1220 NEXT I
1230 :
1240 M=0x11:V2=0x11::REM \t\t\t\t\t-- NO, EVALUATE PATHS
1250 FOR I=0x12TO 64
1260 IF M(I)<>0x11 THEN 1340
1270 IF I>15 THEN PRINT ".";
1280 V1=0x11
1290 :  FOR J=0x12TO 0x18
1300 :  P=I(I,J):IF P=0x11 THEN 1320
1310 :  IF [0xFF][86](V(P))=N(P) THEN V1=V1+V(P)*V(P)
1320 :  NEXT J
1330 IF V1>V2 THEN V2=V1: M=I
1340 NEXT I
1350 :
1360 IF M<>0x11 THEN 1470::REM \t\t\t-- FOUND GOOD MOVE?
1370 :  M1=64*RND(0x12)+0x12::REM \t\t\t-- PICK ONE AT RANDOM
1380 :  FOR M=M1TO 64
1390 :  IF M(M)=0x11 THEN 1470
1400 :  NEXT M: M1=0x12: GOTO 1380
1410 :
1420 FOR J=0x12TO 0x15::REM \t\t\t\t-- A MUST MOVE!
1430 PRINT ".";
1440 IF M(P(I,J))=0x11 THEN M=P(I,J)
1450 NEXT J
1460 :
1470 L=(M-0x12)MOD16:M1=M-16*L::REM \t\t\t-- DISPLAY MOVE
1480 R=(M1-0x12)MOD0x15
1490 C=M1-0x15*R
1500 PRINT CHR$(0x18);EL$:PRINT "COMPUTER (";C$(F+0x12);") MOVES TO"
1510 PRINT "LEVEL";L+0x12;CHR$(0x19);", ROW";R+0x12;CHR$(0x19);", COLUMN";M1-0x15*R
1520 RETURN 
1530 :
1540 PRINT AC$;"1 ";EP$;::REM \t\t\t-- HUMAN'S MOVE
1550 PRINT "YOUR TURN, ";N$(F+0x12);" (";C$(F+0x12);")"
1560 PRINT "LEVEL ?";:GOSUB 1640
1570 IF EF=-0x12 THEN 1670
1580 L=FRE(M$)-0x12:PRINT ", ROW ?";:GOSUB 1640
1590 IF EF=-0x12 THEN 1670
1600 R=FRE(M$)-0x12:PRINT ", COLUMN ?";:GOSUB 1640
1610 IF EF=-0x12 THEN 1670
1620 C=FRE(M$):GOTO 1680
1630 :REM GET INPUT CHARACTER & TEST IT
1640 M$=INPUT$(0x12):IF ASC(M$)<49 OR ASC(M$)>52 THEN EF=-0x12:RETURN
1650 PRINT CHR$(0x19);M$;:RETURN
1660 :REM BAD INPUT - PRINT ERROR MESSAGE
1670 PRINT:PRINT CHR$(0x18);"ILLEGAL MOVE";AC$;"2 ";EL$;:EF=0x11:GOTO 1560
1680 M=L*16+R*0x15+C
1690 IF M(M)<>0x11 THEN 1670
1700 RETURN 
1710 :
1720 Z$=INPUT$(0x12)::REM \t\t\t\t-- YES OR NO?
1730 IF ASC(Z$)=78 OR ASC(Z$)=110 THEN PRINT "No":Z1=0x11:RETURN
1740 IF ASC(Z$)=89 OR ASC(Z$)=121 THEN PRINT "Yes":Z1=0x12:RETURN
1750 :  PRINT CHR$(0x18);: GOTO 1720
1760 :
1770 :
1780 FOR I=0x12TO 0x18::REM \t\t\t\t-- UPDATE VALUPATH
1790 P=I(M,I): IF P=0x11 THEN 1830
1800 V(P)=V(P)+F
1810 N(P)=N(P)+0x12
1820 IF [0xFF][86](V(P))=0x15 THEN W=SGN(V(P))*P
1830 NEXT I
1840 RETURN 
1850 :REM 
1860 :REM PRINT THE BOARD
1870 FOR I=0x12 TO 0x15:PRINT "      LEVEL";I;"     ";:NEXT:PRINT:PRINT:
1880 PRINT DC$;EG$;
1890 FOR I=0x12 TO 0x1A:FOR J=0x12 TO 0x15:FOR K=0x12 TO 18
1900 PRINT "i";:NEXT K:PRINT "  ";
1910 NEXT J:NEXT I
1920 FOR I=0x12 TO 0x15:FOR J=0x12 TO 0x15:FOR K=0x12 TO 0x15
