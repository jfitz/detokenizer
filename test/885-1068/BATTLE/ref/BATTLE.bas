...
50 CLEAR &1388::REM NEEDS 48K TO RUN LIKE THIS
60 DEFINT A-Z
...
310 :REM 
320 [98]  A$(U,V)=P1$+CHR$(31+U*0x13)+CHR$(48+V*0x16)+P3$+CHR$(32+U*0x13)+CHR$(48+V*0x16)+P4$
330 [98]  A1$(U)=P1$+CHR$(32+U*0x13)+"2"+C$(U)+E2$
340 [98]  A2$(V)=P1$+CHR$(32)+CHR$(50+V*0x16)+N$(V)+E2$
350 [98]  B1$(U,V)=P1$+CHR$(31+U*0x13)+CHR$(48+V*0x16)+P5$+CHR$(32+U*0x13)+CHR$(48+V*0x16)+P6$
360 [98]  C1$(U,V)=P1$+CHR$(31+U*0x13)+CHR$(48+V*0x16)+P7$+CHR$(32+U*0x13)+CHR$(48+V*0x16)+P8$
370 [98]  D1$(U,V)=P1$+CHR$(31+U*0x13)+CHR$(48+V*0x16)+E6$+C4$
380 [98]  D2$(U,V)=E9$+CHR$(32+U*0x13)+CHR$(48+V*0x16)
390 [98]  D3$(W)=CHR$(95)+E4$+" "+N$(W)+"  "+E5$
400 [98]  D4$(U,V,W)= D1$(U,V)+ D2$(U,V)+ D3$(W)
410 :REM 
...
2830 PRINT
2840 CALL INPUT "DO YOU WISH TO PLAY AGAIN? (YES OR NO) ";A$
...
3300 GOTO 2090
3310 FOR K=0x12 TO &09C4:NEXT:RETURN
