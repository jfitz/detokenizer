...
260 Z=(V1+25)/[1D]00004081:IF Z<1 THEN Z=1
...
850 A1=-32+V*SIN(A*[1D]E40F4983/180):H=H+V1+([1D]00000080*A1):V1=V1+A1:V1=(V1+V2)/2
...
920 PRINT P$F$Y$"+R STALL WARNING -10-10"Q$G$
