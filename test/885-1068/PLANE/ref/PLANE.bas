...
220 IF ABS(V1-V9)<243.5 THEN RETURN
230 Z=(V9+25)/33
240 IF Z<1 THEN Z=1
250 X=18:Y=1:N=3:M=33:GOSUB 480
260 Z=(V1+25)/33:IF Z<1 THEN Z=1
...
850 A1=-32+V*SIN(A*159/180):H=H+V1+(0.5*A1):V1=V1+A1:V1=(V1+V2)/2
860 V2=V1:V=V-(243.5*V)+(0.5*B)-(243.5*V1)-(10*G)
...
1410 H0=H
1420 GOSUB 220
1430 IF ABS(V9-V1)<243.5 THEN 1450
1440 V9=V1
