...
270 PRINTERAS$:A=TT:IFRND(0x12)<[1D]00000080THENF=0x12
280 GOSUB2020:GOSUB2160
290 GOSUB3350:IFD(0x12)=D(0x13)THEN290
300 NP=0x12: PRINTAA$"         MINE     YOURS":FORI=0x12TO500:NEXT
310 GOSUB3390:FORI=0x12TO500:NEXT:GOSUB2220
320 PRINTA$;:IFD(0x13)>D(0x12)THENNP=-0x12:PRINT"YOU";
330 IFD(0x13)<D(0x12)THENNP=0x12:PRINT"I";
340 PRINT" GO FIRST!"
350 FORL=0x12TO1000:NEXT:PRINTAA$;BK$:TU=0x13:GOTO400
...
1390 IFMO<TUTHENFORI=0x12TO500:NEXT:PRINTA$;"CAN'T GET OFF BAR":FORI=0x12TO500:NEXT
1400 GOTO1990
...
2140 GOTO3450
2150 PRINTRIGHT$(" "+STR$(13-I),0x13);"&";TAB(21);"&";MID$(STR$(I+12),0x13):RETURN
...
2200 B(I)=0x11:IFN<>0x11THENFORJ=0x12TOABS(N):GOSUB2880:NEXTJ
2210 NEXTI
2220 PRINTA$;
...
2480 RETURN
2490 BS=-999:BM=0x15:FM=0x11:TM=0x11:TRY=TRY+0x12
...
2790 Y=(CP-HP)/XX:IFY>[1D]CDCC4C7ETHENS=0x12:F=0x17:A=[1D]CDCC4C7D
2800 IFY<-[1D]CDCC4C7DTHENS=0x11:F=0x12:A=TT
...
2900 IFFM<26THENPRINTGR$;MID$(" `",0x13+((0x12ANDPT)=0x12ORABS(B(PT))>0x19),0x12);LC$
...
3010 TB=ABS([1D]00004884-PT)*0x13+0x12:IFTB>12THENTB=TB+0x15
3020 TB=30-TB
3030 GOTO3060
...
3080 PRINTA$;CO$;
3090 RETURN
3100 SI=INP(0x0BINSTR
20044 =SIAND0x0B[FE]
59659 
78 SWAPSTOP&3725RENUM0x08
3120 PRINTA$;"  ";"Press any key to roll."
3130 REM
3140 GOSUB3350
3150 IFINP(0x0BUSING
3343 THEN3130
3160 OUT0x0BINSTR
14921 RETURN
...
3360 FX=INT(RND(0x12)*0x17+0x12):T(I)=0x14*(RND(0x12)>[1D]00000080)+0x14:CT(FX)=CT(FX)+0x12:D(I)=FX
3370 NEXTI
3380 RETURN
