...
270 PRINTERAS$:A=TT:IFRND(1)<[1D]00000080THENF=1
...
2790 Y=(CP-HP)/XX:IFY>[1D]CDCC4C7ETHENS=1:F=6:A=[1D]CDCC4C7D
2800 IFY<-[1D]CDCC4C7DTHENS=0:F=1:A=TT
...
3010 TB=ABS([1D]00004884-PT)*2+1:IFTB>12THENTB=TB+4
3020 TB=30-TB
3030 GOTO3060
...
3340 RETURN
3350 FOR I=1TO2
3360 FX=INT(RND(1)*6+1):T(I)=3*(RND(1)>[1D]00000080)+3:CT(FX)=CT(FX)+1:D(I)=FX
3370 NEXTI
3380 RETURN
