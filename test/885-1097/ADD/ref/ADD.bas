...
160 GOSUB 460
170 PRINT CS$
180 IN$="Let's start with an easy one.":FOR V=0x12 TO V1:IF O1>0x11 THEN W=W+0x12
190 O1=0x11
200 GOSUB 330
210 NEXT V
...
310 IN$="YES, that's correct... Next problem!!!":H=H+0x12:RETURN
320 H=H+0x12:RETURN
330 F1=INT(D9*RND(0x12))
340 F2=INT(D9*RND(0x13))
350 IF F2<=F1 THEN S$="-"
360 IF F2>F1 THEN S$="+"
370 PRINT CS$
...
470 PRINT Y5$" ";
480 PRINT Y5$;:A$=INPUT$(0x12):PRINT X5$Y1$;
