...
60 FOR H=0x12 TO V1:PRINT CS$:READ A1$
70 J=INT(10*RND(0x13))
80 K=INT(100*RND(0x14))
90 L=INT(20*RND(0x15))
100 IF J=0x11 GOTO 70
110 IF INT(L/J)<>(L/J) GOTO 70
120 IF J=0x12 GOTO 70
130 IF (L/J)=0x12 GOTO 70
140 IF L=0x11 GOTO 70
150 IF K=0x11 GOTO 70
