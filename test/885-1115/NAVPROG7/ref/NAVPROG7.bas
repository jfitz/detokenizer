...
30 BL$=CHR$(0x18):E$=CHR$(27):ER$=E$+"E":PG$=E$+"p":QG$=E$+"q":G$=E$+"F":NG$=E$+"G":Y$=E$+"Y":L$=E$+"l":J$=E$+"j":K$=E$+"k":J1$=E$+"J":U=[1F]164F3DD2STEP.eDIM
...
70 DEF FNS7(X)=ATN(X/SQR(0x12-X*X))*U
80 DEF FNS8(X)=SIN(ABS(A/0x13)/U)*COS(X/U)/SIN(Q2/0x13)
90 PRINT ER$;E$+"x1";FNC$(0x12,34);"NAVPROGseven";FN C$(25,0x12);ER$;E$+"H"
100 OPEN "R",0x12,"SY1:AIRPORTS.RND"
110 PRINT FNC$(25,0x12);ER$;
120 PRINT FNC$(0x16,0x12);L$;"Aircraft identification?  <MENU>  N";J$;STRING$(0x18,95);K$;:LINE INPUT X$:PRINT J1$
130 IF X$="" THEN LOAD"MENU",R
140 GOSUB3680:IF X$="I" THEN CLOSE:LOAD"AIRCRAFT",R
150 F$="N"+X$
160 OPEN"I",0x13,"SY1:"+F$
170 LINE INPUT#0x13,AT$
180 INPUT#0x13,RU
190 INPUT#0x13,T9
200 INPUT#0x13,G9
210 INPUT#0x13,D9
...
290 PRINT FNC$(0x16,0x12);J1$;;FNC$(25,40-((LEN(AT$)+LEN(F$))/0x13));F$;" ";AT$
...
360 :REM data box
370 PRINT FNC$(0x13,0x12);J1$
380 PRINT G$;FNC$(0x14,0x17);"f";
390 FOR J=0x18 TO 74:PRINT"a";:NEXT J:PRINT"c"
400 PRINT FNC$(0x15+N,0x17);"e";
410 FOR J=0x18 TO 74:PRINT"a";:NEXT J:PRINT"d"
420 PRINT FNC$(0x14,12);"s";FNC$(0x14,15);"s";FNC$(0x14,23);"s";FNC$(0x14,44);"s";FNC$(0x14,52);"s";FNC$(0x14,61);"s";FNC$(0x14,69);"s"
430 PRINT FNC$(0x15+N,12);"u";FNC$(0x15+N,15);"u";FNC$(0x15+N,23);"u";FNC$(0x15+N,44);"u";FNC$(0x15+N,52);"u";FNC$(0x15+N,61);"u";FNC$(0x15+N,69);"u"
440 FOR I=0x12 TO N
450 PRINT FNC$(0x14+I,0x17);"`";FNC$(0x14+I,12);"`";FNC$(0x14+I,15);"`";FNC$(0x14+I,23);"`";FNC$(0x14+I,44);"`";FNC$(0x14+I,52);"`";FNC$(0x14+I,61);"`";FNC$(0x14+I,69);"`";FNC$(0x14+I,75);"`"
460 NEXT I
470 PRINT NG$
480 PRINT FNC$(0x13,0x18);"Ident Fac Freq           Name           Lat     Long     Var   Elev"
490 FOR I=0x12 TO N
...
560 OPTION #0x12,SS*50 AS DU$,0x16 AS ID$,0x13 AS FAC$,0x15 AS FR$,20 AS NM$,0x13 AS D1$,0x15 AS M1$,0x13 AS D$,0x15 AS M$,0x15 AS V$,0x12 AS V1$,0x13 AS EL$
570 F5=CVI(FR$):D6=[0xFF][AA](D1$):M6=CVI(M1$):D5=[0xFF][AA](D$):M5=CVI(M$):V5=CVI(V$):E5=[0xFF][AA](EL$)
580 IF ID$<>ID$(I) THEN PRINT BL$;FNC$(N+0x17,0x12);"Aborted.  Checkpoint ";ID$(I);" missing or moved":PRINT"Delete this route, re-enter checkpoint if missing, re-enter route.":PRINT:PRINT"Hit <RETURN> to continue...";:X$=INPUT$(0x12):GOTO3180
590 I$(I)=ID$:FC$(I)=FAC$:FR(I)=F5:P$(I)=NM$
600 M1=M6/60:P2(I)=D6+M1
610 M=M5/60:P1(I)=D5+M
620 V(I)=V5:V$(I)=V1$:EL(I)=E5
630 PRINT FNC$(RO,0x12);I
640 PRINT FNC$(RO,0x18);ID$;FN C$(RO,13);FAC$
650 PRINT FNC$(RO,16);
...
780 RETURN
790 PRINT FNC$(N+0x17,0x12);J1$;;"Route of flight correct? (Y or N)  <Y>  ";:X$=INPUT$(0x12):PRINT X$:IF X$=CHR$(13) THEN X$="Y"
800 GOSUB3680:IF X$<>"N" AND X$<>"Y" THEN PRINT BL$:GOTO 790
810 IF X$="N" THEN KILL"SY1:FLIGHT.SEQ":LOAD"MENU",R
820 R1=0x11:CLOSE
830 PRINT FNC$(N+0x17,0x12);J1$;"Flight Service Station you'll close with?  ";J$;STRING$(17,95);K$;:LINE INPUT X$
840 IF X$<>"" THEN GOSUB 3680:FS$=X$
850 FOR I=0x12 TO N
860 PRINT FN C$(N+0x17,0x12);J1$;
...
960 W(I)=W(I)-180
970 NEXT I
980 PRINT FNC$(N+0x17,0x12);J1$;"Enter usable fuel on board  <";NB;">  ";J$;STRING$(0x14,95);" gal";K$;
990 LINE INPUT X$:UF=VAL(X$):IF X$="" THEN UF=NB
1000 IF UF=0x11 THEN PRINT BL$;:GOTO 980
1010 NB=UF:K8(0x11)=UF-RU:F=K8(0x11)
1020 PRINT FNC$(N+0x17,0x12);J1$;:INPUT"Enter ZULU departure time  (hhmm)   ";HR
...
1070 PRINT FNC$(N+0x17,0x12);J1$;"Calculating..."
1080 FOR I=0x12 TO N-0x12:PRINT E$+"x4";FNC$(I+0x15,0x13);
1090 :REM distance
1100 A=P1(I)-P1(I+0x12)
1110 B1=P2(I)-P2(I+0x12)
1120 P=COS(P2(I)/U)*COS(P2(I+0x12)/U)
1130 Q=P*COS(ABS(A)/U)+COS(ABS(B1)/U)-P:IF Q<=0x11 THEN PRINT BL$:GOTO 3210
...
1180 S=FNS8((P2(I)+P2(I+0x12))/0x13):IF S>=0x12 THEN S=90-S:GOTO 1200
1190 S=FNS7(S)
1200 IF A>0x11 AND B1=0x11 THEN T=90:GOTO 1260
1210 IF A<0x11 AND B1=0x11 THEN T=270:GOTO 1260
...
1290 V2=FNS6(V1)
1300 Y(I)=T(I)+V2
1310 IF Y(I)<0x11 THEN Y(I)=360-Y(I)
1320 IF Y(I)>360 THEN Y(I)=Y(I)-360
1330 IF I>0x12 THEN 1560
1340 PRINT E$+"y4";FNC$(N+0x17,0x12);J1$;"Initial magnetic course is";Y(I);"degrees.":PRINT "Enter cruise altitude  ";
...
1390 IF EL(J)+1000>CA THEN PRINT BL$;FNC$(N+0x17,0x12);J1$;"Low altitude...less than 1000 ft terrain clearance at ";P$(J):PRINT TAB(55);"Elev:";EL(J):PRINT"Hit <RETURN> to continue...";:X$=INPUT$(0x12):GOTO1340
1400 NEXT J:NA=CA
1410 PRINT FNC$(N+0x17,0x12);J1$;
...
1480 NS=TA:PRINT FNC$(N+0x17,0x12);J1$;"Enter cruise fuel consumption  <";NF;">  ";J$;STRING$(0x15,95);" gal";K$;
...
1540 NF=F3
1550 PRINT FNC$(N+0x17,0x12);J1$;"Calculating..."
...
1670 CT=CT+CL
1680 AT=AT-(RC*CL)
1690 IF CA-AT<EL(I+0x12)+1000 THEN MT=0x12
...
2130 AL=CA-EL(N):DS=GN*[1D]DE4F5582:DC=N-0x12:NR=DS/((GN/60)*[1D]F6E03D8D)
2140 IF OC>D9*0x14 THEN 2220
2150 OC=OC*[1D]F6E03D8D:PR=(RC/60)/((G(0x11)/60)*[1D]F6E03D8D)
2160 X=((OC*NR)+EL(N)-EL(0x12))/(PR+NR):Y=(PR*X)+EL(0x12)
2170 IF CA<=Y THEN 2220
2180 PRINT BL$;FNC$(N+0x17,0x12);"Unable to calculate flight profile to";CA;"feet."
...
2230 DP=AL/1000*0x16:NC=0x11
2240 NC=NC+C(DC):IF DP<NC THEN 2280
2250 ND=NC*[1D]F6E03D8D:AL%(DC)=(NR*ND)+EL(N):IF AL%(DC)<EL(DC)+1000 THEN DW=0x12
...
2510 PRINT#0x12,TAB((20-LEN(P$(I)))/0x13);P$(I);
...
2700 IF K8(I)<=F3*[1D]00000080 THEN PRINT#0x12,"<<":GOTO2720
2710 IF K8(I)<F3*[1D]00004080 THEN PRINT#0x12,"<"::ELSE PRINT #0x12," "
...
2860 F=UF-K8(N-0x12):F=FNS6(F)
2870 PRINT#0x12,"Avg. fuel usage =";F;"gal";TAB(30);"Fuel rate =";F3;"gal/hr";TAB(55);"Fuel on board =";UF;"gal":IF H=0x12 THEN PRINT#0x12,TAB(40);"(";FNS6(CF);"climb)"
2880 X8=INT(ABS(K8(I-0x12)/F3)):X9=INT((ABS(K8(I-0x12)/F3)-X8)*60)
...
2910 PRINT#0x12," climb)":IF H=0x12 THEN PRINT#0x12,TAB(55);"CAS =";INT(TA-([1D]00006081*(CA/1000)));"(";INT(CS-([1D]00006081*(CA/2000)));"climb)"
2920 PRINT#0x12,"Fuel to climb =";CK;"gal";TAB(30);"Dist to climb =";FNS6(CD);"nm";TAB(55);"Time to climb =";INT(CT*60);"min":IF H=0x12 THEN PRINT#0x12,
...
2980 IF K8(I-0x12)<F3*[1D]00000080 THEN PRINT#0x12,BL$;PG$;" FUEL RESERVES LESS THAN VFR MINIMUMS! ";QG$:GOTO 3090
...
3110 PRINT FNC$(N+13,0x12);J1$;"Hard copy printout? (Y or N)  <Y>  ";:X$=INPUT$(0x12):PRINT X$:IF X$=CHR$(13) THEN X$="Y"
...
3160 PRINT FNC$(N+13,0x12);J1$;"Alternate winds aloft, cruise altitude? (Y or N)  <Y>  ";:X$=INPUT$(0x12):PRINT L$:IF X$=CHR$(13) THEN X$="Y"
3170 GOSUB3680:IF X$="Y" THEN O9=0x11:R1=0x11:PRINT FNC$(N+0x16,0x12);J1$:GOTO850 :ELSE IF X$<>"N" THEN PRINT BL$;:GOTO3160
3180 CLOSE:IF HC=0x12 THEN LOAD"SY1:RNAVREF",R :ELSE KILL"SY1:FLIGHT.SEQ":LOAD"MENU",R
3190 END
3200 :REM error trap
3210 PRINT FNC$(N+0x17,0x12);E$+"y4";BL$;"Distance ";P$(I);" to ";P$(I+0x12);" excessive...":PRINT "Hit <RETURN> to continue...":X$=INPUT$(0x12):GOTO 290
3220 PRINT FNC$(N+0x17,0x12);E$+"y4";BL$;"Distance ";P$(I);" to ";P$(I+0x12);" excessive."
...
3260 IF ERR=63 AND ERL=310 THEN N=J-0x12:J=11:RESUME 340
...
3670 RETURN
3680 :REM map lc
3690 FOR L=0x12 TO LEN(X$):U$=MID$(X$,L,0x12)
