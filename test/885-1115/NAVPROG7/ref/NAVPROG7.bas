...
60 [98] S5(X)=SIN(X/U):[98] S6(X)=INT(X*10+[1D]00000080)/10
...
2060 L3=INT(L1+O4)
2070 L2=INT((L1+O4-L3)*&0258+[1D]00000080)/10
...
2250 ND=NC*[1D]F6E03D8D:AL%(DC)=(NR*ND)+EL(N):IF AL%(DC)<EL(DC)+&03E8 THEN DW=0x12
...
2910 PRINT#0x12," climb)":IF H=0x12 THEN PRINT#0x12,TAB(55);"CAS =";INT(TA-([1D]00006081*(CA/&03E8)));"(";INT(CS-([1D]00006081*(CA/&07D0)));"climb)"
