...
630 PI=J
640 IF FD>1 THEN REC=(JMOD5)+1:SS=J [FC] 5:GET#1,REC:GOSUB 780:FD=FD+1:RO=RO+1
650 IF FD=0 THEN FD=1:REC=(JMOD5)+1:SS=J [FC] 5:GET#1,REC
660 NEXT J
