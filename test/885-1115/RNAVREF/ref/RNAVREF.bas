...
80 BL$=CHR$(7):E$=CHR$(27):ER$=E$+"E":U=[1F]184F3DD2STEP.eDIM
...
520 REC=(PIMOD5)+1:SS=PI [FC] 5
530 GET #1,REC
540 :REM decode
550 OPTION #1,SS*50 AS DU$,5 AS ID$,2 AS FAC$,4 AS FR$,20 AS NM$,2 AS D1$,4 AS M1$,2 AS D$,4 AS M$,4 AS V$,1 AS V1$,2 AS EL$
