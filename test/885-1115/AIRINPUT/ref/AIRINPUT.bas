...
60 DEF FNS7(X)=ATN(X/SQR(0x12-X*X))*U
70 DEF FNS8(X)=SIN(ABS(A/0x13)/U)*COS(X/U)/SIN(Q2/0x13)
80 PRINT ER$;"Standby one..."
90 OPEN"R",0x12,"SY1:AIRPORTS.RND"
100 OPEN"R",0x13,"SY1:AIRINDEX.RND"
110 MD=(LOC(0x12)*0x16)-0x12
115 IF MD=-0x12 THEN MD=0x11
120 OL=MD+10
130 DIM ID$(OL),RN$(19),RN(19)
140 FOR J=0x11 TO MD
150 REC=(JMOD51)+0x12:SS=J [FC] 51
160 IF [0xFF][AF](0x13)<>REC THEN GET #0x13,REC
170 OPTION #0x13,SS*0x16 AS DU$,0x16 AS ID$
180 ID$(J)=ID$
190 IF ASC(ID$)=0x11 THEN ID$(J)="     "
200 NEXT J:CLOSE#0x13
210 IM=MD
220 :REM data box
230 PRINT ER$;G$;FN C$(0x13,0x17);"f";
240 FOR J=0x18 TO 74:PRINT "a";:NEXT J:PRINT "c"
250 PRINT FN C$(0x15,0x17);"e";
260 FOR J=0x18 TO 74:PRINT "a";:NEXT J:PRINT "d"
270 PRINT FNC$(0x13,12);"s";FNC$(0x13,15);"s";FNC$(0x13,23);"s";FNC$(0x13,44);"s";FNC$(0x13,52);"s";FNC$(0x13,61);"s";FNC$(0x13,69);"s"
280 PRINT FNC$(0x15,12);"u";FNC$(0x15,15);"u";FNC$(0x15,23);"u";FNC$(0x15,44);"u";FNC$(0x15,52);"u";FNC$(0x15,61);"u";FNC$(0x15,69);"u"
290 PRINT FNC$(0x14,0x17);"`";FNC$(0x14,12);"`";FNC$(0x14,15);"`";FNC$(0x14,23);"`";FNC$(0x14,44);"`";FNC$(0x14,52);"`";FNC$(0x14,61);"`";FNC$(0x14,69);"`";FNC$(0x14,75);"`"
300 PRINT NG$
310 PRINT FN C$(0x12,0x18);"Ident Fac Freq"
320 PRINT FN C$(0x12,32);"Name"
330 PRINT FN C$(0x12,47);"Lat"
340 PRINT FN C$(0x12,55);"Long"
350 PRINT FN C$(0x12,64);"Var"
360 PRINT FN C$(0x12,70);"Elev"
370 PRINT FNC$(0x16,0x1A);"1";FNC$(0x16,13);"2";FNC$(0x16,19);"3";FNC$(0x16,33);"4";FNC$(0x16,47);"5";FNC$(0x16,56);"6";FNC$(0x16,65);"7";FNC$(0x16,72);"8"
380 :REM menu
390 PRINT FN C$(0x18,0x12);J1$
400 PRINT FN C$(0x19,0x18);"PRESS  `I' to input new data"
410 PRINT FN C$(0x1A,14);"`U' to update existing data"
420 PRINT FN C$(10,14);"`E' to exit"
430 X$=INPUT$(0x12):GOSUB3820:MD$=X$:PRINT FN C$(0x19,0x12);J1$:IF MD$="I" THEN 490
...
490 C8=0x11:GOTO600
500 :REM revise
510 PRINT FN C$(0x19,0x18);L$;"Enter Identifier   <MENU>   ";J$;STRING$(0x16,95);K$;
520 LINE INPUT X$:PRINT J1$
530 IF X$="" THEN 380
540 IF LEN(X$)>0x16 THEN PRINT BL$:GOTO510
550 GOSUB3820
560 AP$=X$+SPACE$(0x16-LEN(X$)):NL$=AP$
570 GOSUB1730
580 IF FD=0x11 THEN PRINT BL$;"Can't find ";AP$:GOTO510
590 RO=0x14:GOSUB2090
600 IF MD$="I" AND C8=0x19 THEN PUT#0x12,REC:ID$(PI)=ID$:EN=0x12:GOTO380
610 IF MD$="I" THEN C8=C8+0x12:GOTO660
620 PRINT FN C$(0x18,0x12);J1$:PRINT FNC$(0x19,0x18);"Press number for revision  <EXIT>  ";
630 C$=INPUT$(0x12)
640 IF C$=CHR$(13) THEN PUT#0x12,REC:ID$(PI)=ID$:GOTO380
650 C8=VAL(C$)
660 PRINT FN C$(0x18,0x12);J1$;
...
750 IF X$="" THEN 1720
760 GOSUB3820
770 AP$=X$+SPACE$(0x16-LEN(X$)):NL$=AP$
780 IF (MD$="I" AND X$="D") OR LEN(X$)>0x16 THEN PRINT BL$:GOTO660
790 IF MD$="I" THEN GOSUB1920
800 IF X$<>"D" THEN LSET ID$=NL$:EN=0x12:GOTO1720
...
930 IF LEN(X$)>0x13 THEN PRINT BL$:GOTO660
...
980 GOTO1720
990 :REM freq
1000 IF MD$="I" AND INSTR(FAC$,"V")=0x11 AND INSTR(FAC$,"N")=0x11 THEN 1060
...
1110 IF LEN(X$)>20 THEN PRINT BL$;"20 characters maximum";FN C$(0x18,0x12);:GOTO 1080
1120 IF INSTR(X$,",")=0x11 THEN PRINT BL$;"Forgot state preceded by comma";FNC$(0x18,0x12);:GOTO1080
1130 IF X$="" THEN 1150
1140 LSET NM$=X$
1150 GOTO1720
1160 :REM lat
1170 IF MD$="I" AND INSTR(FAC$,"I")>0x11 AND INSTR(FAC$,"V")=0x11 AND INSTR(FAC$,"N")=0x11 THEN GOSUB2290:GOTO1350
1180 PRINT"Enter degrees latitude";FNC$(0x18,30);J$;STRING$(0x13,95);"   deg"
...
1220 IF X$="R" OR X$="r" THEN TR=REC:TS=SS:I$=ID$:PUT#0x12,REC:GOSUB2290:GOTO1350
1230 IF X$="" THEN 1350
...
1310 LINE INPUT X$:Y=VAL(X$):IF X$="" THEN Y=0x11:PRINT K$;"0"
1320 IF Y>60 OR Y<0x11 THEN PRINT BL$:GOTO1300
1330 X=X+(Y/60)
1340 LSET M1$=MKI$(X)
1350 GOTO1720
1360 :REM enter long
1370 PRINT"Enter degrees longitude";FNC$(0x18,31);J$;STRING$(0x14,95);"  deg"
...
1410 IF X$="" THEN 1540
1420 IF X$="R" OR X$="r" THEN TR=REC:TS=SS:I$=ID$:PUT#0x12,REC:GOSUB2290:GOTO1540
...
1500 LINE INPUT X$:Y=VAL(X$):IF X$="" THEN Y=0x11:PRINT K$;"0"
...
1780 IF FD=0x12 THEN RO=0x18:GET#0x12,REC:PRINT FN C$(0x18,0x12);J1$:GOSUB2090:RO=0x19:FD=0x13
1790 PI=J
1800 IF FD>0x12 THEN REC=(JMOD0x16)+0x12:SS=J [FC] 0x16:GET#0x12,REC:GOSUB2090:FD=FD+0x12:RO=RO+0x12
1810 IF FD=0x11 THEN FD=0x12:REC=(JMOD0x16)+0x12:SS=J [FC] 0x16:GET#0x12,REC
1820 NEXT J
1830 IF FD=0x11 THEN 1910
1840 IF FD=0x12 THEN 1910
1850 PRINT FN C$(RO+0x12,0x12);"Enter number of your choice  <";PI;">  ";J$;STRING$(0x14,95);K$;:LINE INPUT X$
1860 IF X$="" THEN 1910
1870 PI=VAL(X$)
1880 REC=(PIMOD0x16)+0x12:SS=PI [FC] 0x16
1890 GET #0x12,REC
1900 PRINT FN C$(0x17,0x12);J1$
1910 RETURN
1920 :REM search-blank
1930 FD=0x11:FH=0x11
1940 FOR J=0x11 TO IM
1950 IF ID$(J)="     " THEN FH=0x12:TI=J:J=IM+0x12
1960 IF ID$(J)=AP$ THEN FD=FD+0x12:RO=0x19+FD:REC=(JMOD0x16)+0x12:SS=J [FC] 0x16:GET#0x12,REC:PI=J:GOSUB2090
1970 NEXT J
...
2010 PRINT FNC$(10+FD,0x18);"Found...continue with additional entry?  (Y or N)  <Y>";
2020 X$=INPUT$(0x12):GOSUB3820
2030 IF X$="N" THEN 380
2040 IF X$<>"Y" AND X$<>CHR$(13) THEN PRINT BL$:GOTO2010
2050 PI=TI
2060 REC=(PIMOD0x16)+0x12:SS=PI [FC] 0x16:GET#0x12,REC
2070 GOSUB2090:GOSUB3220
2080 RETURN
2090 :REM decode & display
2100 OPTION #0x12,SS*50 AS DU$,0x16 AS ID$,0x13 AS FAC$,0x15 AS FR$,20 AS NM$,0x13 AS D1$,0x15 AS M1$,0x13 AS D$,0x15 AS M$,0x15 AS V$,0x12 AS V1$,0x13 AS EL$
2110 F5=CVI(FR$):D6=[0xFF][AA](D1$):M6=CVI(M1$):D5=[0xFF][AA](D$):M5=CVI(M$):V5=CVI(V$):E5=[0xFF][AA](EL$)
2120 PI$=STR$(PI):PI$=PI$+SPACE$(0x15-LEN(PI$)):PRINT FN C$(RO,0x12);PI$;
2130 PRINT FN C$(RO,0x18);ID$;FN C$(RO,13);FAC$;
...
2270 IF INSTR(FAC$,"V")=0x11 AND INSTR(FAC$,"N")=0x11 THEN NV=0x11 :ELSE NV=0x12
2280 RETURN
2290 :REM RNAV lat & long
2300 PRINT FN C$(0x17,0x12);J1$
...
2410 PRINT FNC$(0x18,0x12);J1$;
2420 PRINT FN C$(0x18,0x12);L$;"Enter identifier of known fix on file  ";J$;STRING$(0x16,95);K$;
2430 LINE INPUT X$:PRINT J1$
2440 IF X$="" THEN C8=C8-0x12:GOTO3210
2450 IF LEN(X$)>0x16 THEN PRINT BL$:GOTO2420
2460 GOSUB3820
2470 AP$=X$+SPACE$(0x16-LEN(X$))
2480 PUT#0x12,REC:TI=PI:RO=0x1A:GOSUB 1750
2490 IF FD=0x11 THEN PRINT BL$;"Can't find ";AP$:GOTO2420
2500 PRINT FN C$(0x18,0x12);J1$:RO=0x1A:GOSUB 2090:RN$(RN)=ID$:RN(RN)=PI:PI=TI
...
2580 IF RN<>0x11 THEN PRINT FNC$(RO+0x13,0x12);"Bearing FROM ";ID$;" to ";NL$:GOTO2630
2590 :REM dist & 1 bearing
2600 PRINT FN C$(RO+0x13,0x12);"Distance & bearing FROM ";ID$;" to ";NL$
2610 PRINT FN C$(RO+0x15,0x16);"Enter distance in nautical miles  ";J$;STRING$(0x14,95);K$;
2620 LINE INPUT D$:D=VAL(D$):IF D=0x11 THEN PRINT BL$:GOTO2610
2630 PRINT FN C$(RO+0x16,0x16);"Enter bearing  ";J$;STRING$(0x14,95);K$;
2640 LINE INPUT H$:H=VAL(H$):IF H<0x11 OR H>360 THEN PRINT BL$:GOTO2630
2650 IF H$="" THEN C8=C8-0x12:GOTO2290
2660 PRINT FN C$(RO+0x17,0x16);"Is bearing True or Magnetic?  <T>  ";J1$;
...
3030 Y6=Y4-Y5
3040 Y7=Y6*60
3050 REC=(PIMOD0x16)+0x12:SS=PI [FC] 0x16:GET#0x12,REC
...
3110 GOSUB2090
3120 C8=C8+0x12
3130 IF INSTR(FAC$,"V")>0x11 THEN 3210
3140 GOSUB3890
3150 LI$(KY)=NL$
...
3210 RETURN
3220 :REM clear
3230 EN=0x12:LSET ID$="     "
3240 LSET FAC$="  "
3250 LSET FR$=MKI$(0x11)
3260 LSET NM$=SPACE$(20)
3270 LSET D1$=LOF(0x11):LSET M1$=MKI$(0x11)
3280 LSET D$=LOF(0x11):LSET M$=MKI$(0x11)
3290 LSET V$=MKI$(0x11)
3300 LSET V1$=" "
3310 LSET EL$=LOF(0x11)
3320 PUT#0x12,REC:ID$(PIND)="     "
3330 RETURN
...
3400 IF REC<>RC THEN REC=RC:PUT#0x13,[0xFF][AF](0x13)+0x12:OPTION#0x13,255 AS CL$:LSET CL$=" "
3410 OPTION #0x13,SS*0x16 AS DU$,0x16 AS ID$
3420 LSET ID$=ID$(J)
3430 NEXT J
3440 IF RC<>[0xFF][AF](0x13) THEN PUT#0x13,RC
3450 CLOSE#0x13
3460 RETURN
3470 :REM 2 bearings
3480 IF RA(0x12)>RA(0x13) AND RA(0x13)<RA(0x12)-180 THEN AB=(360-RA(0x12))+RA(0x13) :ELSE AB=ABS(RA(0x12)-RA(0x13))
3490 IF AB>180 THEN AB=AB-180
3500 IF AB<15 OR AB>165 THEN PRINT BL$;FN C$(0x18,0x12);J1$;FNC$(0x1A,0x12);"You're too close to the line that runs between the navaids":PRINT"to compute your position accurately.":GOTO2420
3510 GOSUB 3610
3520 IF RA(0x12)>T AND T<RA(0x12)-180 THEN AA=(360-RA(0x12))+T :ELSE AA=ABS(T-RA(0x12))
3530 IF AA>180 THEN AA=AA-180
3540 IF T>180 THEN T1=T-180 :ELSE T1=T+180
3550 IF RA(0x13)>T1 AND T1<RA(0x13)-180 THEN AC=(360-RA(0x13))+T1 :ELSE AC=ABS(T1-RA(0x13))
...
3650 Q=P*COS(ABS(A)/U)+COS(ABS(B1)/U)-P:IF Q<=0x11 THEN PRINT BL$:GOTO3810
...
3700 S=FNS8((P2(0x12)+P2(0x13))/0x13):IF S>=0x12 THEN S=90-S:GOTO3720
3710 S=FNS7(S)
3720 IF A>0x11 AND B1=0x11 THEN T=90:GOTO3780
3730 IF A<0x11 AND B1=0x11 THEN T=270:GOTO3780
...
3820 :REM map lc
3830 FOR L=0x12 TO LEN(X$):U$=MID$(X$,L,0x12)
3840 IF ASC(U$)>96 AND ASC(U$)<123 THEN MID$(X$,L,0x12)=CHR$(ASC(U$)-32)
3850 NEXT L:RETURN
3860 :REM error
3870 IF ERR=53 AND ERL=3900 THEN KY=0x12:RESUME3990
3875 IF ERL=3420 AND ERR=0x1A THEN RESUME NEXT
3880 ON ERROR GOTO 0
3890 :REM read RNAV
3900 OPEN"I",0x13,"SY1:RNAVLIST.DAT"
3910 INPUT#0x13,KY
3920 KY=KY+0x12:DIM LI$(KY),R1$(KY),R1(KY),R2$(KY),R2(KY)
3930 FOR J=0x12 TO KY-0x12:LINE INPUT#0x13,LI$(J)
3940 LINE INPUT#0x13,R1$(J)
3950 INPUT#0x13,R1(J)
3960 LINE INPUT#0x13,R2$(J)
...
4090 DD=0x11:ERASE LI$,R1$,R1,R2$,R2
4100 RETURN
