...
40 BL$=CHR$(0x18):E$=CHR$(27):ER$=E$+"E":PG$=E$+"p":QG$=E$+"q":Y$=E$+"Y":L$=E$+"K":J$=E$+"j":K$=E$+"k":J1$=E$+"J":U=0x1F0x16O=[D2]STEP.eDIM
50 [98]C$(C1,C2)=Y$+CHR$(C1+31)+CHR$(C2+31):H$=C$(0x13,0x12)
60 [98]S6(X)=INT(X*10+bad float0x1D)/10
...
930 IF C>PD OR (ML>60 AND C>PD*bad float0x1D) THEN 1090
...
1160 IF BD<ML*bad float0x1D THEN CY=CY-0x12
1170 IF B2<ML*bad float0x1D THEN CY=CY-0x13
