...
40 BL$=CHR$(7):E$=CHR$(27):ER$=E$+"E":PG$=E$+"p":QG$=E$+"q":Y$=E$+"Y":L$=E$+"K":J$=E$+"j":K$=E$+"k":J1$=E$+"J":U=[1F]164F3DD2STEP.eDIM
...
1160 IF BD<ML*[1D]C2F5287F THEN CY=CY-1
1170 IF B2<ML*[1D]C2F5287F THEN CY=CY-2
