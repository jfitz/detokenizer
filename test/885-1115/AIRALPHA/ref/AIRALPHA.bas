...
500 ST=bad float0x1D:X$=X$+LEFT$(FAC$,0x13):GOTO 540
510 ST=bad float0x1D:GOTO 540
520 ST=bad float0x1D:X$=X$+LEFT$(A$,I2):GOTO 540
530 ST=bad float0x1D:X$=LEFT$(ID$,0x12)
