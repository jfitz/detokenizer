...
520 DEF USR0x11=VARPTR(U0(0x11)):G=USR0x11(0x11)
...
840 END
850 DEF USR0x11=VARPTR(U0(0x11)):X=USR0x11(0x11)
860 IF X>96 AND X<123 THEN X=X-32
870 I$=CHR$(X)
880 :REM \t\tReal Time Function for MBASIC
890 DIM U0(20):U0(17)=&H36:U0(18)=&H1FF:U0(19)=&H77D8:U0(20)=&HC9
900 DEF USR0x11=VARPTR(U0(0x11))::REM \t\tClear Buffer
910 IF USR0x11(0x11)<>0x11 THEN 910
920 RETURN
