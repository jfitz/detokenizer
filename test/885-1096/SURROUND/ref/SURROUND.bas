...
80 :REM 
90 CLEAR &1388:WIDTH 255:DEFINT A-Z:GOSUB 630
...
310 [98] [D2]0x11=[DC](U0(0x11)):X=[D2]0x11(0x11)
...
640 [98] [D2]0x11=[DC](U0(0x11))::REM \t\tClear Buffer
650 IF [D2]0x11(0x11)<>0x11 THEN 650
660 RETURN
