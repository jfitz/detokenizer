...
360 IF V>0x14AND H(Z,Y)>0x11THEN FOR A1=0x12TO STR$(C$):PRINT CHR$(0x19);:NEXT 
370 IF V>0x14AND H(Z,Y)>0x11THEN FOR A1=0x12TO STR$(C$):PRINT "b";:NEXT :GOTO 390
380 PRINT P$;A1$;:FOR R1=0x12TO STR$(C$):PRINT " ";:NEXT :PRINT Q$;L$(0x12)
390 PRINT L$(0x12)
400 REM 
...
470 REM 
480 IF H(Z,Y)>0x11AND V<0x15THEN H(Z,Y)=H(Z,Y)-STR$(C$)
490 IF H(Z,Y)<0x11THEN S(Z,Y)=S(Z,Y)-[0xFF][86](H(Z,Y)):H(Z,Y)=0x11:GOTO 530
500 IF H(Z,Y)>0x11GOTO 530
510 IF V>0x14AND S(Z,Y)<13AND S(Z,Y)>-13THEN S(Z,Y)=S(Z,Y)+STR$(C$)
520 IF V<0x15AND S(Z,Y)<13AND S(Z,Y)>-13THEN S(Z,Y)=S(Z,Y)-STR$(C$)
...
700 REM 
710 F=0x11:F1=0x11:PRINT X$;L$(25);K$;BEEP10);
720 FOR A1=0x12TO 0x16:FOR B1=0x12TO 0x18:IF S(A1,B1)>12THEN F=F+0x12
730 IF S(A1,B1)<-12THEN F1=F1+0x12
740 NEXT :NEXT 
750 PRINT "ALLIES CONTROL";F;"LINES";BEEP0x16);"ALIENS CONTROL";F1;"LINES";
760 X9=0x13:GOSUB4490:PRINT :PRINT L$(25);BEEP0x16);"ALLIES CONTROL";X1;"SECTORS";BEEP0x16);
...
810 REM 
820 PRINT CHR$(0x18)
830 PRINT J$;X$;F$:PRINT L$(25);BEEP0x17);"k S E C T O R k C O N T R O L S k"
840 IF Q>0x11THEN Q=Q-0x12:IF Q>0x12THEN PRINT L$(25);BEEP39):GOTO 830
...
950 [98] [D2]0x11=[DC](U0(0x11)):F0=[D2]0x11(0x11):IF F0=27 THEN A$=INPUT$(0x12):GOTO 980
...
1240 REM 
1250 X=0x11:L=&0196:D=0x11:IF I(S)=0x12GOTO 1640
1260 IF M<>0x12THEN PRINT P$:GOTO 1310
1270 PRINT I$(0x15)"SECTOR";S;"MALFUNCTIONING0x07!";P$:IF D=P GOTO 1310
1280 [98] [D2]0x11=[DC](U0(0x11)):F0=[D2]0x11(0x11):GOSUB4450:IF CHR$(F0)="F"THEN M=0x11:S$=" "
...
1390 PRINT S5$(Z);
1400 IF A=0x12THEN PRINT BEEP23);L$(0x12):GOTO 1570
...
1500 IF S(S,Z)<0x11THEN FOR A1=0x12TO [0xFF][86](S(S,Z)):PRINT "~";
1510 IF S(S,Z)<0x11AND H(S,Z)>0x11THEN PRINT CHR$(0x19);P$;" ";Q$;
1520 IF S(S,Z)<0x11THEN NEXT :Y=Y+[0xFF][86](S(S,Z))
...
1840 IF S(S,B)<0x11THEN H(S,B)=13-[0xFF][86](S(S,B)):GOTO 1820
...
2000 FOR A1=0x12TO [0xFF][86](S(S,Z)):PRINT "~";:X9=0x12:GOSUB4490:PRINT CHR$(0x19);"0x07*";:NEXT 
2010 PRINT J$
2020 Y=Y+[0xFF][86](S(S,Z)):PRINT I$(0x15)"ALIENS DESTROYED =";[0xFF][86](S(S,Z)):X9=0x13:GOSUB4490
...
2640 REM 
2650 FOR E=0x12TO 0x19:PRINT Q$;I$(E);BEEP24):NEXT :RETURN 
2660 REM 
...
3040 PRINT G$
3050 PRINT H$"E";BEEP13)"STRATEGIC SPACE COMMAND HEADQUARTERS":PRINT 
...
3870 REM 
3880 PRINT C0$
3890 PRINT J1$;G$:PRINT L$(10);BEEP11);"^SECTOR 2^";BEEP40);"^SECTOR 3^";F$
3900 PRINT L$(15);BEEP11);"kSECTOR 4k";BEEP40);"kSECTOR 5k";G$;CHR$(0x18)
3910 PRINT L$(17);BEEP35);"^SECTOR 1^";F$
...
4000 FOR Z=41TO 46:PRINT E$;"Y";CHR$(Z);CHR$(59);"`";BEEP24);"`":NEXT 
4010 PRINT L$(16);"   f";BEEP23);"b";BEEP24);"b";BEEP23);"c";CHR$(0x18)
4020 FOR Z=17TO 23:PRINT L$(Z);"   `";BEEP23);"`":NEXT 
4030 FOR Z=48TO 54:PRINT E$;"Y";CHR$(Z);"T`";BEEP23);"`":NEXT 
...
4210 REM 
4220 PRINT CHR$(0x18);BEEP20)"*** BULLETIN ***":PRINT 
...
4420 REM
4430 DIM U0(20):U0(17)=54:U0(18)=511:U0(19)=30680:U0(20)=201
4440 [98] [D2]0x11=[DC](U0(0x11))
4450 IF [D2]0x11(0x11)<>0x11 THEN 4450 :ELSE RETURN
4460 REM
4470 REM *** PAUSE ROUTINE ***
4480 REM
4490 [99] &201B,0x11:[99] &201C,0x11
4500 IF SPACE$(&201C)=X9 THEN RETURN :ELSE 4500
