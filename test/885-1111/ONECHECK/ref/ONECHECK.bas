1 :REMARK \t\t\t\tONECHECK
2 :REMARK 
3 :REMARK \t\tConverted to MBASIC and the H19 Terminal
4 :REMARK \t\t\tBY: Thomas C. Kyle
5 :REMARK \t\t\t    4600 Franklin Av
6 :REMARK \t\t\t    Western Springs, IL 60558
7 :REMARK \t\t\t    312-246-2874
8 :REMARK 
9 :REMARK 
10 :REMARK 
100 DIM A$(64)
...
8700 :REMARK 
8800 :REMARK \t\t\tH19.SUBROUTINE
8900 :REMARK 
10800 E$=CHR$(27):E1$=E$+"E":YG$=E$+"F":NG$=E$+"G"
10900 YR$=E$+"p":NR$=E$+"q":YC$=E$+"y5":NC$=E$+"x5"
11000 CP$=E$+"Y":Y25$=E$+"x1":N25$=E$+"y1"
11100 RETURN
11200 :REMARK \t\t\tE1$  = ERASE SCREEN
11210 :REMARK \t\t\tYG$  = ENTER GRAPHICS MODE
11220 :REMARK \t\t\tNG$  = EXIT GRAPHICS MODE
11230 :REMARK \t\t\tYR$  = ENTER REVERSE VIDEO MODE
11240 :REMARK \t\t\tNR$  = EXIT REVERSE VIDEO MODE
11250 :REMARK \t\t\tYC$  = CURSOR ON
11260 :REMARK \t\t\tNC$  = CURSOR OFF
11270 :REMARK \t\t\tCP$  = POSITION CURSOR
11280 :REMARK \t\t\tY25$ = ENABLE 25th LINE
11290 :REMARK \t\t\tN25$ = DISABLE 25th LINE
